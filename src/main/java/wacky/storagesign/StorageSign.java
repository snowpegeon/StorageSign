...
public class StorageSign {
    ...
    public StorageSign(Sign sign, Material signmat) {
        ...
        if (mat == Material.ENCHANTED_BOOK) {
            ...
            damage = NumberConversions.toShort(line2[1]);
...
//        }
    ...
    protected String getShortName() {
        ...
        } else if (mat == Material.OAK_SIGN && damage == 1) {
            return "OakStorageSign";

        } else if (mat == Material.SPRUCE_SIGN && damage == 1) {
            return "SpruceStorageSign";

        } else if (mat == Material.BIRCH_SIGN  && damage == 1) {
            return "BirchStorageSign";

        } else if (mat == Material.JUNGLE_SIGN && damage == 1) {
            return "JungleStorageSign";

        } else if (mat == Material.ACACIA_SIGN && damage == 1) {
            return "AcaciaStorageSign";

        } else if (mat == Material.DARK_OAK_SIGN && damage == 1) {
            return "DarkOakStorageSign";

        } else if (mat == Material.CRIMSON_SIGN && damage == 1) {
            return "CrimsonStorageSign";

        } else if (mat == Material.WARPED_SIGN  && damage == 1) {
            return "WarpedStorageSign";

        } else if (mat == Material.MANGROVE_SIGN && damage == 1) {
            return "MangroveStorageSign";

        } else if (mat == Material.CHERRY_SIGN && damage == 1) {
            return "CherryStorageSign";

        } else if (mat == Material.BAMBOO_SIGN && damage == 1) {
        ...
        //else if (mat == Material.LEGACY_HUGE_MUSHROOM_2) return damage == 0 ? "RED_MUSH_BLOCK" : "RED_MUSH_BLO:" + damage;
            ...
            return "ENCHBOOK:" + EnchantInfo.getShortType(ench) + ":" + damage;
        ...
        if (mat.toString().length() > limit) {
            if (damage != 0) {
                return mat.toString().substring(0, limit) + ":" + damage;
    ...
    public ItemStack getStorageSign() {
        ...
        if (isEmpty) {
            ...
            list.add(mat.toString() + ":" + ench.getKey().getKey() + ":" + damage + " " + amount);
    ...
    public String getSigntext(int i) {
        ...
        sign[3] = String.valueOf(amount / 3456) + "LC " + String.valueOf(amount % 3456 / 64) + "s "
                + String.valueOf(amount % 64);
        return sign[i];
    }
    ...
    public ItemStack getContents() {
        ...
        if (mat == Material.STONE_SLAB) {
            ...
            return new ItemStack(mat, 1);
                ...
                || mat == Material.CHERRY_SIGN
                || mat == Material.BAMBOO_SIGN) {

            if (damage == 0) {
                return new ItemStack(mat, 1);

            } else {
                return emptySign(mat);
    ...
    public boolean isSimilar(ItemStack item) {
        ...
        if (mat == Material.ENCHANTED_BOOK && item.getType() == Material.ENCHANTED_BOOK) {
            ...
            if (enchantMeta.getStoredEnchants().size() == 1) {
                ...
                if (itemEnch == ench && enchantMeta.getStoredEnchantLevel(itemEnch) == damage) {
                    return true;
